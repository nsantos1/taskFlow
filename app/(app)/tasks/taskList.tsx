  ...
  return (
    <div className="mt-6 bg-white border border-ink-200 rounded-xl2 overflow-hidden">
      ...
      {tasks.map((task) => (
        <div
          key={task.id}
          className="grid grid-cols-[1fr_120px_100px_120px_90px] gap-4 px-5 py-3 items-center border-b border-ink-100 last:border-b-0 hover:bg-ink-50 transition-colors"
        >
